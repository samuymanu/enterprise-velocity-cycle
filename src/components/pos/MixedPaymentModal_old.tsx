...
function MixedPaymentModalComponent({ open, onOpenChange, total, cartItems, onPaymentComplete }: MixedPaymentModalProps) {
  ...
  // Estados separados para mejorar UX
  const [loadingCustomers, setLoadingCustomers] = useState(false); // carga de clientes
  const [processing, setProcessing] = useState(false);             // envío de pago
  ...
  console.log('[MixedPaymentModal] Estado:', {
    open,
    total,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <Card>
              ...
              <CardContent className="space-y-4 relative">
                {/* Overlay solo si total es 0 */}
                {(total || 0) <= 0 && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/80 dark:bg-gray-900/70 rounded-md z-10 text-center p-4">
                    <p className="text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">Agrega productos al carrito para habilitar pagos.</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">El total actual es 0.</p>
                  </div>
                )}
                {/* Pagos tradicionales */}
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      value={cashUSDAmount}
                      onChange={(e) => { 
                        console.log('[MixedPaymentModal] change USD', e.target.value); 
                        setCashUSDAmount(e.target.value); 
                      }}
                      onFocus={() => console.log('[MixedPaymentModal] focus USD')}
                      onClick={() => console.log('[MixedPaymentModal] click USD')}
                      onKeyDown={(e) => console.log('[MixedPaymentModal] keydown USD', e.key)}
                      inputMode="decimal"
                      style={{ border: '2px solid red', pointerEvents: 'auto', backgroundColor: 'yellow' }}
                      autoComplete="off"
                    />
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      inputMode="decimal"
                      style={{ border: '2px solid blue', pointerEvents: 'auto' }}
                    />
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      inputMode="decimal"
                      style={{ border: '2px solid green', pointerEvents: 'auto' }}
                    />
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              ...
              <Button onClick={handleCompletePayment} disabled={(remainingAmount || 0) > 0.01 || processing || (total||0)<=0} className="flex-1">
